...
#define CLASS_BASE_HEALTH 5000
#define CLASS_HEALTH_PER_PLAYER 350
#define CLASS_SPEED 1.0
#define CLASS_GRAVITY 1.0


char g_szClass[][] =  { "normal", "Infected Scientist", "Balanced Attributes", "models/player/kuristaja/zombies/gozombie/gozombie.mdl", "5000", "350", "5" };
...
public void OnMapStart() {
	...
	LoadDirOfModels("materials/models/player/kuristaja/zombies/gozombie");
	LoadDirOfModels("models/player/kuristaja/zombies/gozombie");
}
