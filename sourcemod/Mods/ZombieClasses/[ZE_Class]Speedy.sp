...
#define CLASS_BASE_HEALTH 4000
#define CLASS_HEALTH_PER_PLAYER 200
#define CLASS_SPEED 1.14
#define CLASS_GRAVITY 0.95

char g_szClass[][] =  { "speedy", "Speedy", "-HP +KnockBack +Speed +Gravity", "models/player/kuristaja/zombies/bman/bman.mdl", "4000", "200", "8" };
...
public void OnMapStart() {
	...
	LoadDirOfModels("materials/models/player/kuristaja/zombies/bman");
	LoadDirOfModels("models/player/kuristaja/zombies/bman");
}
